...
const WIKI = {
  ...
  orbweaver: "Orb-weaver spider",
  firefly: "Firefly",
  wolfspider: "Wolf spider",
  lunamoth: "Luna moth",
  leafinsect: "Phyllium giganteum",
  velvetant: "Dasymutilla occidentalis",
  goliathbeetle: "Goliathus goliatus",
  whipscorpion: "Thelyphonida",
  rattlesnake: "Rattlesnake",
  roadrunner: "Greater roadrunner",
  kangaroorat: "Kangaroo rat",
  desertcentipede: "Scolopendra heros",
  stingray: "Stingray",
  ...
  moray: "Moray eel",
  lionfish: "Lionfish",
  pistolshrimp: "Alpheidae",
  horseshoecrab: "Horseshoe crab",
  manowar: "Portuguese man o' war",
  ...
  leaftailedgecko: "Uroplatus",
  indri: "Indri",
  hissingcockroach: "Gromphadorhina portentosa",
  takahe: "Takahē",
  galapagossealion: "Galápagos sea lion",
  wombat: "Wombat",
  meerkat: "Meerkat",
  prairiedog: "Prairie dog",
  armadillo: "Armadillo",
  aardvark: "Aardvark",
  molecricket: "Gryllotalpa gryllotalpa",
  trapdoorspider: "Cyclocosmia"
};
